...
#                                             transforms.RandomGrayscale(p=0.2),
        ...
        self.img_list = label_dict['files'][:999900]
        self.feature_list = label_dict['features']
  
        print(len(self.img_list))

    def __getitem__(self, index):
        
        fid = self.img_list[index]        
        label = self.feature_list[index]
        fid = fid.split('.')[0]+'.jpg'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--label_dict_path', type=str, default='../LDA/texts_label_bert_ins.pk', help='label dict')
    ...
    parser.add_argument('--feature_dim', type=int, default=768, help='feature dimension for output')  
    ...
    parser.add_argument('--model_pre', type=str, default='TextTopicNet_bert_ins_', help=' model prefix ')
