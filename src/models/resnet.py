...
class InsResNet50(nn.Module):
    ...
    def __init__(self, width=1, feature_dim=128):
        super(InsResNet50, self).__init__()
        
        self.encoder = resnet50(pretrained=True, width=width)
        self.encoder.fc = nn.Sequential(nn.Linear(width * 2048, 1024),
...
class ResNetV1(nn.Module):
    def __init__(self, name='resnet50'):
        ...
        if name == 'resnet50':
            self.l_to_ab = resnet50(in_channel=1, width=0.5, low_dim=128)
            self.ab_to_l = resnet50(in_channel=2, width=0.5, low_dim=128)
        elif name == 'resnet18':
            self.l_to_ab = resnet18(in_channel=1, width=0.5, low_dim=128)
            self.ab_to_l = resnet18(in_channel=2, width=0.5, low_dim=128)
        elif name == 'resnet101':
            self.l_to_ab = resnet101(in_channel=1, width=0.5, low_dim=128)
            self.ab_to_l = resnet101(in_channel=2, width=0.5, low_dim=128)
        else:
...
class ResNetV2(nn.Module):
    def __init__(self, name='resnet50'):
        ...
        if name == 'resnet50':
            self.l_to_ab = resnet50(in_channel=1, width=1, low_dim=128)
            self.ab_to_l = resnet50(in_channel=2, width=1, low_dim=128)
        elif name == 'resnet18':
            self.l_to_ab = resnet18(in_channel=1, width=1, low_dim=128)
            self.ab_to_l = resnet18(in_channel=2, width=1, low_dim=128)
        elif name == 'resnet101':
